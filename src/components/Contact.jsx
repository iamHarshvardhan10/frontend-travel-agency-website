...
const Contact = () => {
  return (
    <div>
      ...
      <h1 className="mx-[160px] my-[130px] text-[100px] text-white">Contact</h1>
      <div className="mx-[171px] mt-[300px]">
        <h1 className="text-[75px] text-gray-700 ">Start Your Journey</h1>
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-[32px] text-gray-600 mt-[50px]">
              Contact or visit us
            </h1>
            <p className="font-workSans w-[80%]">
          ...
          <div className="flex flex-col gap-4">
            <input
              type="text"
              placeholder="Name"
              className="w-[585px] p-4 border border-gray-500 outline-none placeholder:font-workSans"
            />
            <input
              type="email"
              placeholder="Email"
            ...
            <textarea
              placeholder="Message"
              className="w-[585px] h-[120px] p-4 border border-gray-500 outline-none placeholder:font-workSans"
            ></textarea>
      ...
      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d205265.84004139755!2d-74.15164345115979!3d40.70875509269342!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c24fa5d33f083b%3A0xc80b8f06e177fe62!2sNew%20York%2C%20NY%2C%20USA!5e0!3m2!1sen!2sin!4v1716883262251!5m2!1sen!2sin" className="w-full h-[350px] mt-[50px]" allowFullScreen="" loading="lazy" ></iframe>
    </div>
  );
};
