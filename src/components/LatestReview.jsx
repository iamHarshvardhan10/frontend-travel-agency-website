    ...
    <div className="relative">
      <div className="parllaxImg1">
        ...
        <div className="absolute top-0 lg:mx-[171px] lg:my-[100px] sm:mx-[100px] max-sm:mx-[10px]">
          <h1 className="text-center font-handwriting lg:text-[32px] sm:text-[36px] max-sm:text-[36px] text-white">
            our customer love us
          </h1>
          <h1 className="text-center lg:text-[75px] sm:text-[42px] max-sm:text-[36px] text-white">Latest Reviews</h1>
          ...
          <div className="lg:grid lg:grid-cols-2 lg:mt-[80px] md:flex md:flex-col ">
            {sliceReview.map((review, index) => (
              <div
                ...
                }  lg:px-[50px] lg:py-[50px] lg:border-none lg:rounded-none lg:mb-0 sm:border max-sm:border sm:px-4 max-sm:p-2 sm:mb-2 max-sm:mb-[10px] sm:rounded-2xl`}
              >
